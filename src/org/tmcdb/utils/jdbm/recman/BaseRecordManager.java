...
package org.tmcdb.utils.jdbm.recman;

import org.tmcdb.utils.jdbm.Serializer;
import org.tmcdb.utils.jdbm.SerializerInput;
import org.tmcdb.utils.jdbm.SerializerOutput;
import org.tmcdb.utils.jdbm.helper.OpenByteArrayInputStream;
import org.tmcdb.utils.jdbm.helper.OpenByteArrayOutputStream;
import org.tmcdb.utils.jdbm.helper.RecordManagerImpl;
...
public final class BaseRecordManager
    ...
    private void reopen() throws IOException {
        ...
        if (versionNumber > STORE_FORMAT_VERSION)
            throw new IOException("Unsupported version of store. Please update org.tmcdb.utils.jdbm. Minimal supported ver:" + STORE_FORMAT_VERSION + ", store ver:" + versionNumber);
