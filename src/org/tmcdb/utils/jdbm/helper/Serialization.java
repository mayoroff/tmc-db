 ...
 ******************************************************************************/
package org.tmcdb.utils.jdbm.helper;

import org.tmcdb.utils.jdbm.recman.BlockIo;
    ...
    public static Object readObject(DataInputStream is) throws IOException, ClassNotFoundException {
        ...
        switch (head) {
            ...
            case SHORT_1:
                ...
                break;
            case SHORT_255:
                ret = Short.valueOf((short) is.read());
                break;
            case SHORT_FULL:
            ...
            case DOUBLE_FULL:
                ...
                break;
            case BLOCKIO:
                ret = deserializeBlockIo(is);
                break;
            case STOREREFERENCE:
                ret = deserializeStoreReference(is);
                break;
            case STRING_255:
                ret = deserializeString256Smaller(is);
                break;
            case STRING:
            ...
            case STRING_EMPTY:
                ...
                break;
            case ARRAYLIST_255:
                ret = deserializeArrayList256Smaller(is);
                break;
            case ARRAYLIST:
                ret = deserializeArrayList(is);
                break;
            case ARRAYLIST_PACKED_LONG:
                ret = deserializeArrayListPackedLong(is);
                break;
            case ARRAY_OBJECT_255:
                ret = deserializeArrayObject256Smaller(is);
                break;
            case ARRAY_OBJECT:
            ...
            case ARRAY_OBJECT_PACKED_LONG:
                ...
                break;
            case LINKEDLIST_255:
                ret = deserializeLinkedList256Smaller(is);
                break;
            case LINKEDLIST:
                ret = deserializeLinkedList(is);
                break;
            case TREESET_255:
                ret = deserializeTreeSet256Smaller(is);
                break;
            case TREESET:
                ret = deserializeTreeSet(is);
                break;
            case HASHSET_255:
                ret = deserializeHashSet256Smaller(is);
                break;
            case HASHSET:
                ret = deserializeHashSet(is);
                break;
            case LINKEDHASHSET_255:
                ret = deserializeLinkedHashSet256Smaller(is);
                break;
            case LINKEDHASHSET:
                ret = deserializeLinkedHashSet(is);
                break;
            case VECTOR_255:
                ret = deserializeVector256Smaller(is);
                break;
            case VECTOR:
                ret = deserializeVector(is);
                break;
            case TREEMAP_255:
                ret = deserializeTreeMap256Smaller(is);
                break;
            case TREEMAP:
                ret = deserializeTreeMap(is);
                break;
            case HASHMAP_255:
                ret = deserializeHashMap256Smaller(is);
                break;
            case HASHMAP:
                ret = deserializeHashMap(is);
                break;
            case LINKEDHASHMAP_255:
                ret = deserializeLinkedHashMap256Smaller(is);
                break;
            case LINKEDHASHMAP:
                ret = deserializeLinkedHashMap(is);
                break;
            case HASHTABLE_255:
                ret = deserializeHashtable256Smaller(is);
                break;
            case HASHTABLE:
                ret = deserializeHashtable(is);
                break;
            case PROPERTIES_255:
                ret = deserializeProperties256Smaller(is);
                break;
            case PROPERTIES:
                ret = deserializeProperties(is);
                break;
            case CLASS:
            ...
            case ARRAY_LONG_PACKED:
                ...
                break;
            case ARRAY_BYTE_255:
                ret = deserializeArrayByte255(is);
                break;
            case ARRAY_BYTE_INT:
